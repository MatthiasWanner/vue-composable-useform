import { IUseFormState, FormHandler, RegisterInput } from '../types';
...
const useForm = () => {
   ...
   * @param field string used in id and name attributes to recover value in handleSubmit function
   * @returns object with id and name values
   */
